...
function App() {
  ...
  let name = ["All", "Design", "Development"];
  // console.log(filteredMenu);
  if (Filter != "") {
    Filter.filter((e) => e.name == setFilter);
  }
  return (
          ...
          <div className="col-lg-4 sticky-lg-top vh-100">
            <div className="d-flex flex-column h-100 text-center overflow-auto shadow">
              <img
                ...
                alt="Image"
              />
              <h1 className="text-info mt-2 text-uppercase">
                Md. Fayzullah Aman
              </h1>
              <span
                className="mb-4"
              ...
              <div className="d-flex align-items-end justify-content-between border-top">
                ...
                <a href="#" className="btn w-50 btn-scroll">
                  Contact Me
                </a>
              </div>
            </div>
            ...
            >
              ...
              <div className="row mb-4">
                <div className="col-sm-6 py-1">
                  <span className="fw-medium text-info">Name:</span> Md
                  Fayzullah Aman
                </div>
                <div className="col-sm-6 py-1">
                  <span className="fw-medium text-info">Birthday:</span> 29
                  December 1995
                </div>
                <div className="col-sm-6 py-1">
                ...
                <div className="col-sm-6 py-1">
                  <span className="fw-medium text-info">Experience:</span> 1
                  Years
                </div>
                <div className="col-sm-6 py-1">
                  <span className="fw-medium text-info">Phone:</span> +01795
                  504043 / +01916 955766
                </div>
                <div className="col-sm-6 py-1">
                ...
                <div className="col-sm-6 py-1">
                  <span className="fw-medium text-info">Freelance:</span>{" "}
                  Available
                </div>
              </div>
