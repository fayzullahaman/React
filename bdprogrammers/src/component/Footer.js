      ...
      <div className="container py-5">
          <div className="row g-5">
              <div className="col-md-6">
                  <h1 className="text-white mb-4"><img style={{width: "10%"}} className="img-fluid me-3" src="/assets/img/web.png" alt=""/>Bdprogrammers</h1>
              ...
              <div className="col-lg-3 col-md-6">
                  ...
                  <p><i className="fa fa-map-marker-alt me-3"></i>Dhaka, Bangladesh</p>
                  <p><i className="fa fa-phone-alt me-3"></i>+012 345 67890</p>
                  <p><i className="fa fa-envelope me-3"></i>developer@example.com</p>
              </div>
              <div className="col-lg-3 col-md-6">
          ...
          <div className="container">
              <div className="row">
                  <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                      &copy; <a href="#">bdprogrammers</a>, All Right Reserved.
                  </div>
                  <div className="col-md-6 text-center text-md-end">
                      Designed By <a href="https://bdprogrammers.com">Bd Programmers Team</a>  Distributed by <a href="https://bdprogrammers.com">bdprogrammers.com</a>
                  </div>
              </div>
          </div>
      </div>
